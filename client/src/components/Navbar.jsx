...
import { FaOpencart, FaTasks, FaUser, FaUsers } from "react-icons/fa";
                ...
                <div className="flex justify-between  ">
                  <div className="flex items-center gap-5">
                    <h1 className="text-2xl font-semibold text-center">
                      UMS - <span className="text-zinc-400 "> RBAC</span>
                    </h1>
                  </div>
        ...
        <div className="">
          <div className="w-fit shadow-md h-full rounded-xl">
            <div className="py-10 pl-5 pr-8 text-gray-400 flex flex-col h-full justify-between">
              ...
              <div className="flex items-center justify-center ec gap-3">
                <FaUsers className="text-2xl" />

                <h1 className=" text-center">
                  U<span className="text-zinc-600 ">MS</span>
                </h1>
              </div>
            </div>
          </div>
